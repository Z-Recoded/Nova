...
├── nova_training_data_status.py # Cross-machine DPO pair count backing /training-data-status — same combined/omen_only/aero_only pattern as nova_agent_log_status.py
